 ...
 * de una sola letra o dígito (1-9 en `OptionList`, C y H en `EscenaScreen`) no tiene que
 * disparar nada, porque el jugador está escribiendo, no jugando. Compartida por todos los
 * listeners de teclado de la pantalla de juego para que la regla viva en un solo lugar.
 */
